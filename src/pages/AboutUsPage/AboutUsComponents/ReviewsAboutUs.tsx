        ...
        <section className="dark:bg-gray-900 bg-violet-100">
            <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
                <div className="mx-auto max-w-screen-sm">
                    <h2 className="mb-4 pb-5 text-4xl font-semibold text-blue-500 dark:text-gray-300">
                        Testimonials
                    </h2>
                </div>
                <div className="grid mb-8 lg:mb-12 lg:grid-cols-2">
                    <figure className="flex flex-col justify-center items-center p-8 text-center bg-gray-50 border-b
                    ...
                    <figure className="flex flex-col justify-center items-center p-8 text-center bg-gray-50
