...
const ForgotPassword: React.FC = () => {
    ...
    const handleButtonClick = () => {
        if (formik.errors.email) {
            ...
            toast.success("A message with password recovery instructions has been sent by email.");
            formik.resetForm();
        }
    };
    ...
    return (
        <div className="min-h-screen">
            ...
            <h2 className="text-2xl mb-4 font-semibold text-blue-700">Recover Password</h2>
            <p>Enter the email address you used to register<br/>
                end we'll send you the instruction</p>
            <ToastContainer/>
            <form onSubmit={formik.handleSubmit} className="mt-6 space-y-4 flex justify-center flex-col m-auto w-max">
                ...
                <div className="mt-4 pb-5">
                    <Button label="RESET PASSWORD" type="submit" onClick={handleButtonClick}/>
                    <div>
