...
const ForgotPassword: React.FC = () => {
    ...
    return (
        <div className="min-h-screen">
            ...
            <h2 className="text-2xl mb-4 font-semibold text-indigo-900">Recover Password</h2>
            <p>
            ...
            <form onSubmit={formik.handleSubmit} className="mt-6 space-y-4 flex justify-center flex-col m-auto w-max">
                ...
                <div className="mt-4 pb-5">
                    ...
                    />
                    <div>
                        <Link className="text-lg font-semibold text-indigo-900 hover:text-indigo-500" to="/login">
                            Back to login
                        </Link>
                    </div>
                </div>
